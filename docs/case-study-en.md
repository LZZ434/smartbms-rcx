...
All four injected faults were detected at the fourth persistent 15-minute sample: 4/4 recall, 45-minute delay, and no unexpected findings in the fixed scenario suite. The repository contains 45 passing unit, integration, export, and dashboard-smoke tests.
