...
def run_diagnostics(
    ...
    *,
    ...
    if position is not None:
        ...
        findings.append(
            DiagnosticFinding(
                ...
                estimated_waste_kwh=round(float(residual[sensor_mask].abs().sum()) * dt_hours * 0.08, 3),
    ...
    airflow_ratio = trends["airflow_east"] / trends["airflow_cmd_east"].clip(lower=0.05)
    fan_ratio = trends["fan_power_kw"] / trends["expected_fan_power_kw"].clip(lower=0.05)
    filter_mask = (
    ...
    if position is not None:
        ...
        excess_power = (trends["fan_power_kw"] - trends["expected_fan_power_kw"]).clip(lower=0)
        findings.append(
            DiagnosticFinding(
                ...
                evidence_columns=("airflow_cmd_east", "airflow_east", "fan_power_kw", "expected_fan_power_kw"),
                estimated_waste_kwh=round(float(excess_power[filter_mask].sum()) * dt_hours, 3),
    ...
    if position is not None:
        ...
        findings.append(
            DiagnosticFinding(
                ...
                evidence_columns=("occupied", "cooling_cmd_east", "hvac_power_kw"),
